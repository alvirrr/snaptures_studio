...
<body>
    ...
    <section class="bg-linear-to-t from-neutral-300 to-neutral-200 py-16 px-4">
        <div class="max-w-4xl mx-auto p-8 bg-white rounded-2xl shadow-lg">
            <h2 class="text-3xl font-bold text-gray-800 mb-6">Pilih Jadwal Pemesanan</h2>
            ...
            <form action="{{ route('booking.store') }}" method="POST">
                ...
                <!-- Pilih Tanggal -->
                <div class="mb-6">
                    <label for="booking-date" class="block text-base font-semibold text-gray-700 mb-2">
                        Tanggal Pemesanan
                    </label>
                ...
                <!-- Pilih Waktu -->
                <div class="mb-6">
                    <label class="block text-base font-semibold text-gray-700 mb-3">Pilih Waktu</label>
                    <div id="time-slots" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                        <!-- Contoh slot tersedia -->
                        <button type="button"
                            class="time-slot bg-green-100 text-green-800 px-4 py-2 rounded-xl text-sm font-medium hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-green-500 transition"
                            data-time="10:00">10:00 - 11:00</button>

                        <button type="button"
                            class="time-slot bg-green-100 text-green-800 px-4 py-2 rounded-xl text-sm font-medium hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-green-500 transition"
                            data-time="11:00">11:00 - 12:00</button>

                        <!-- Contoh slot tidak tersedia -->
                        <span
                            class="bg-gray-300 text-gray-500 px-4 py-2 rounded-xl text-sm font-medium cursor-not-allowed flex items-center justify-center">
                            Tidak Tersedia
                        </span>
                    </div>
                </div>
                ...
                <!-- Tombol Submit -->
                <button type="submit"
                    class="mt-6 w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-xl transition">
    ...
    {{-- <div class="max-w-4xl mx-auto p-6 bg-white rounded-2xl shadow-md">
        ...
        <div id="time-slots" class="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <!-- Contoh slot waktu -->
            <button class="time-slot bg-green-100 text-green-700 px-4 py-2 rounded-xl hover:bg-green-200"
            data-time="10:00">10:00 - 11:00</button>
            <button class="time-slot bg-green-100 text-green-700 px-4 py-2 rounded-xl hover:bg-green-200"
                data-time="11:00">11:00 - 12:00</button>
            <button class="time-slot bg-gray-300 text-gray-500 px-4 py-2 rounded-xl cursor-not-allowed" disabled>Tidak
                Tersedia</button>
            <!-- Slot lainnya akan di-generate dari backend -->
        </div>
